...
export default function Landing() {
  ...
  return (
    <div
      id="landing"
      className="flex flex-col-reverse md:flex-row gap-8 text-[#0094C6] py-6 px-6 md:py-10 md:px-32 h-full md:h-screen mb-20"
    >
      <div className="md:w-1/2 md:pr-10 flex flex-col justify-center text-center">
        <h1 className="text-3xl md:text-5xl md:mt-20">
          Hi, I'm Romero Mariano
        </h1>
        <br />
        <section className="text-center max-w-2xl mx-auto my-6">
          <p className="text-[#0094C6] text-lg">
            A dedicated software developer from Argentina experienced in React,
            TypeScript, Node.js and PostgreSQL. I’m passionate about building
            efficient web solutions that combine great performance with
            beautiful design.
          </p>
        </section>
        <div
