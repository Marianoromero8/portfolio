    ...
    return (
        <div id='aboutme' className={'flex flex-col text-[#0094C6] mt-20 h-screen'}>
            ...
            <p className={'text-left pl-10 pr-10 pb-10'}>
                I have experience with JavaScript, C++, React, CSS, Node.js, and PostgreSQL. I graduated from the Soy Henry bootcamp that equips students with practical skills to build dynamic, scalable, and secure web applications using industry best practices and tools.
                <br />
                <br />
